...
def main():
	   ...
	   random3.SetSeed(1)
           ...
           histoEb = TH1F("histoEb", "", 50,63,70) # 172v5
	   histoErrEb = TH1F("histoErrEb", "", 30,0,0.4) # 172v5
           histoPull = TH1F("histoPull", "",100,-100,100)
	
	   pred = 67.57 #172v5
	
	   Npe = 2000 #Number of pseudo experiments
	   ...
	   for i in range(0,Npe):
		...
		for ibin in range(0,histo.GetNbinsX()):
			...
			histoPeak.SetBinContent(ibin,fluctuation)
			err = math.sqrt(fluctuation)/math.exp(x)
