...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-28.91566,-4819.842,212.0482,35346.34);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   mc_stack_5->SetMaximum(28224.55);
   ...
   lep1pt_t#bar{t}_stack_1->SetBinContent(3,18333.72);
   lep1pt_t#bar{t}_stack_1->SetBinContent(4,25725.82);
   lep1pt_t#bar{t}_stack_1->SetBinContent(5,22756.34);
   lep1pt_t#bar{t}_stack_1->SetBinContent(6,18496);
   lep1pt_t#bar{t}_stack_1->SetBinContent(7,14157.25);
   lep1pt_t#bar{t}_stack_1->SetBinContent(8,11246.71);
   lep1pt_t#bar{t}_stack_1->SetBinContent(9,8166.831);
   lep1pt_t#bar{t}_stack_1->SetBinContent(10,6017.805);
   lep1pt_t#bar{t}_stack_1->SetBinContent(11,4502.833);
   lep1pt_t#bar{t}_stack_1->SetBinContent(12,3336.361);
   lep1pt_t#bar{t}_stack_1->SetBinContent(13,2391.51);
   lep1pt_t#bar{t}_stack_1->SetBinContent(14,1860.054);
   lep1pt_t#bar{t}_stack_1->SetBinContent(15,1480.181);
   lep1pt_t#bar{t}_stack_1->SetBinContent(16,1044.342);
   lep1pt_t#bar{t}_stack_1->SetBinContent(17,739.5966);
   lep1pt_t#bar{t}_stack_1->SetBinContent(18,568.7852);
   lep1pt_t#bar{t}_stack_1->SetBinContent(19,491.6327);
   lep1pt_t#bar{t}_stack_1->SetBinContent(20,421.5036);
   lep1pt_t#bar{t}_stack_1->SetBinContent(21,1536.087);
   lep1pt_t#bar{t}_stack_1->SetBinError(3,265.7406);
   lep1pt_t#bar{t}_stack_1->SetBinError(4,314.8811);
   lep1pt_t#bar{t}_stack_1->SetBinError(5,296.5304);
   lep1pt_t#bar{t}_stack_1->SetBinError(6,266.8753);
   lep1pt_t#bar{t}_stack_1->SetBinError(7,234.5344);
   lep1pt_t#bar{t}_stack_1->SetBinError(8,208.7354);
   lep1pt_t#bar{t}_stack_1->SetBinError(9,177.8029);
   lep1pt_t#bar{t}_stack_1->SetBinError(10,153.3359);
   lep1pt_t#bar{t}_stack_1->SetBinError(11,132.6778);
   lep1pt_t#bar{t}_stack_1->SetBinError(12,113.515);
   lep1pt_t#bar{t}_stack_1->SetBinError(13,96.08942);
   lep1pt_t#bar{t}_stack_1->SetBinError(14,84.62722);
   lep1pt_t#bar{t}_stack_1->SetBinError(15,76.27031);
   lep1pt_t#bar{t}_stack_1->SetBinError(16,63.59368);
   lep1pt_t#bar{t}_stack_1->SetBinError(17,53.4271);
   lep1pt_t#bar{t}_stack_1->SetBinError(18,46.89028);
   lep1pt_t#bar{t}_stack_1->SetBinError(19,43.90286);
   lep1pt_t#bar{t}_stack_1->SetBinError(20,40.78329);
   lep1pt_t#bar{t}_stack_1->SetBinError(21,77.64284);
   lep1pt_t#bar{t}_stack_1->SetEntries(39651);
...
// ------------>Primitives in pad: p2
   ...
   Graph_Graph_from_ratio3010->SetMaximum(1.063259);
