...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-36.14458,-4472.656,265.0602,32800.31);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   lep0pt_t#bar{t}_stack_1->SetBinContent(3,21671.3);
   lep0pt_t#bar{t}_stack_1->SetBinContent(4,23922.92);
   lep0pt_t#bar{t}_stack_1->SetBinContent(5,22071.72);
   lep0pt_t#bar{t}_stack_1->SetBinContent(6,18131.72);
   lep0pt_t#bar{t}_stack_1->SetBinContent(7,14223.49);
   lep0pt_t#bar{t}_stack_1->SetBinContent(8,10410.8);
   lep0pt_t#bar{t}_stack_1->SetBinContent(9,7936.626);
   lep0pt_t#bar{t}_stack_1->SetBinContent(10,5855.112);
   lep0pt_t#bar{t}_stack_1->SetBinContent(11,4693.059);
   lep0pt_t#bar{t}_stack_1->SetBinContent(12,3483.222);
   lep0pt_t#bar{t}_stack_1->SetBinContent(13,2628.127);
   lep0pt_t#bar{t}_stack_1->SetBinContent(14,1859.142);
   lep0pt_t#bar{t}_stack_1->SetBinContent(15,1457.466);
   lep0pt_t#bar{t}_stack_1->SetBinContent(16,1163.778);
   lep0pt_t#bar{t}_stack_1->SetBinContent(17,871.4739);
   lep0pt_t#bar{t}_stack_1->SetBinContent(18,606.3373);
   lep0pt_t#bar{t}_stack_1->SetBinContent(19,506.4412);
   lep0pt_t#bar{t}_stack_1->SetBinContent(20,379.1788);
   lep0pt_t#bar{t}_stack_1->SetBinContent(21,281.7224);
   lep0pt_t#bar{t}_stack_1->SetBinContent(22,196.424);
   lep0pt_t#bar{t}_stack_1->SetBinContent(23,196.5495);
   lep0pt_t#bar{t}_stack_1->SetBinContent(24,134.3693);
   lep0pt_t#bar{t}_stack_1->SetBinContent(25,127.6499);
   lep0pt_t#bar{t}_stack_1->SetBinContent(26,464.7283);
   lep0pt_t#bar{t}_stack_1->SetBinError(3,286.3896);
   lep0pt_t#bar{t}_stack_1->SetBinError(4,302.657);
   lep0pt_t#bar{t}_stack_1->SetBinError(5,291.8972);
   lep0pt_t#bar{t}_stack_1->SetBinError(6,264.5134);
   lep0pt_t#bar{t}_stack_1->SetBinError(7,234.468);
   lep0pt_t#bar{t}_stack_1->SetBinError(8,200.3146);
   lep0pt_t#bar{t}_stack_1->SetBinError(9,175.1294);
   lep0pt_t#bar{t}_stack_1->SetBinError(10,152.6505);
   lep0pt_t#bar{t}_stack_1->SetBinError(11,136.6765);
   lep0pt_t#bar{t}_stack_1->SetBinError(12,118.1429);
   lep0pt_t#bar{t}_stack_1->SetBinError(13,102.6461);
   lep0pt_t#bar{t}_stack_1->SetBinError(14,86.29562);
   lep0pt_t#bar{t}_stack_1->SetBinError(15,76.56629);
   lep0pt_t#bar{t}_stack_1->SetBinError(16,68.34236);
   lep0pt_t#bar{t}_stack_1->SetBinError(17,58.94326);
   lep0pt_t#bar{t}_stack_1->SetBinError(18,49.38695);
   lep0pt_t#bar{t}_stack_1->SetBinError(19,44.62955);
   lep0pt_t#bar{t}_stack_1->SetBinError(20,38.94828);
   lep0pt_t#bar{t}_stack_1->SetBinError(21,33.62458);
   lep0pt_t#bar{t}_stack_1->SetBinError(22,27.93149);
   lep0pt_t#bar{t}_stack_1->SetBinError(23,28.2372);
   lep0pt_t#bar{t}_stack_1->SetBinError(24,23.07197);
   lep0pt_t#bar{t}_stack_1->SetBinError(25,22.19694);
   lep0pt_t#bar{t}_stack_1->SetBinError(26,43.1988);
   lep0pt_t#bar{t}_stack_1->SetEntries(39651);
...
// ------------>Primitives in pad: p2
   ...
   Graph_Graph_from_ratio3016->SetMaximum(1.027575);
