...
//=========  (Wed Jan 15 21:35:52 2020) by ROOT version 6.14/09
...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-3.093976,-2495.756,2.689157,18303.05);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__13->SetMaximum(18095.06);
   frame__13->SetEntries(60409);
   ...
   mc_stack_7->SetMaximum(14615.24);
   ...
   bmjeteta_t#bar{t}_stack_1->SetBinContent(1,1724.303);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(2,2657.538);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(3,3600.214);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(4,4837.58);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(5,6362.719);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(6,7432.636);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(7,8775.211);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(8,10513.88);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(9,12262.01);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(10,12722.25);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(11,13073.22);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(12,13344.39);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(13,13106.72);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(14,12932.93);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(15,12900.12);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(16,12009.61);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(17,10937);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(18,9203.221);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(19,7513.992);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(20,6344.916);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(21,5071.317);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(22,3604.701);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(23,2697.318);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(24,1856.175);
   bmjeteta_t#bar{t}_stack_1->SetBinError(1,81.78402);
   bmjeteta_t#bar{t}_stack_1->SetBinError(2,101.0871);
   bmjeteta_t#bar{t}_stack_1->SetBinError(3,117.9319);
   bmjeteta_t#bar{t}_stack_1->SetBinError(4,136.6933);
   bmjeteta_t#bar{t}_stack_1->SetBinError(5,156.9223);
   bmjeteta_t#bar{t}_stack_1->SetBinError(6,169.4212);
   bmjeteta_t#bar{t}_stack_1->SetBinError(7,184.112);
   bmjeteta_t#bar{t}_stack_1->SetBinError(8,201.762);
   bmjeteta_t#bar{t}_stack_1->SetBinError(9,217.7631);
   bmjeteta_t#bar{t}_stack_1->SetBinError(10,221.5913);
   bmjeteta_t#bar{t}_stack_1->SetBinError(11,224.8867);
   bmjeteta_t#bar{t}_stack_1->SetBinError(12,227.2042);
   bmjeteta_t#bar{t}_stack_1->SetBinError(13,224.9451);
   bmjeteta_t#bar{t}_stack_1->SetBinError(14,223.6462);
   bmjeteta_t#bar{t}_stack_1->SetBinError(15,223.184);
   bmjeteta_t#bar{t}_stack_1->SetBinError(16,215.5416);
   bmjeteta_t#bar{t}_stack_1->SetBinError(17,205.6559);
   bmjeteta_t#bar{t}_stack_1->SetBinError(18,188.6393);
   bmjeteta_t#bar{t}_stack_1->SetBinError(19,170.5731);
   bmjeteta_t#bar{t}_stack_1->SetBinError(20,156.6308);
   bmjeteta_t#bar{t}_stack_1->SetBinError(21,140.2265);
   bmjeteta_t#bar{t}_stack_1->SetBinError(22,118.3861);
   bmjeteta_t#bar{t}_stack_1->SetBinError(23,102.3837);
   bmjeteta_t#bar{t}_stack_1->SetBinError(24,84.767);
   bmjeteta_t#bar{t}_stack_1->SetEntries(54018);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__14->SetEntries(60409);
