...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.7228916,-25512.37,5.301205,187091.6);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__21->SetMaximum(184965.5);
   frame__21->SetEntries(32767);
   ...
   mc_stack_11->SetMaximum(149395.2);
   ...
   nleptons_t#bar{t}_stack_1->SetBinContent(3,135321.3);
   nleptons_t#bar{t}_stack_1->SetBinError(3,850.0327);
   nleptons_t#bar{t}_stack_1->SetEntries(27079);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__22->SetEntries(32767);
   ...
   Graph_Graph_from_ratio3022->SetMaximum(1.020438);
