...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-3.093976,-2394.076,2.689157,17557.39);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__13->SetMaximum(17357.88);
   frame__13->SetEntries(43105);
   ...
   mc_stack_7->SetMaximum(14019.82);
   ...
   bmjeteta_t#bar{t}_stack_1->SetBinContent(1,1726.151);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(2,2398.351);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(3,3129.856);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(4,4685.018);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(5,5727.132);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(6,6616.331);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(7,8741.728);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(8,10050.85);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(9,11416.79);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(10,11668.29);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(11,12275.42);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(12,11845.31);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(13,12250.97);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(14,12776.81);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(15,12117.25);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(16,11330.94);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(17,10381.94);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(18,9051.759);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(19,7050.832);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(20,6166.867);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(21,4612.849);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(22,3284.123);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(23,2586.962);
   bmjeteta_t#bar{t}_stack_1->SetBinContent(24,1736.182);
   bmjeteta_t#bar{t}_stack_1->SetBinError(1,95.51714);
   bmjeteta_t#bar{t}_stack_1->SetBinError(2,113.2592);
   bmjeteta_t#bar{t}_stack_1->SetBinError(3,129.0348);
   bmjeteta_t#bar{t}_stack_1->SetBinError(4,157.6517);
   bmjeteta_t#bar{t}_stack_1->SetBinError(5,175.0944);
   bmjeteta_t#bar{t}_stack_1->SetBinError(6,187.6435);
   bmjeteta_t#bar{t}_stack_1->SetBinError(7,216.1146);
   bmjeteta_t#bar{t}_stack_1->SetBinError(8,231.3886);
   bmjeteta_t#bar{t}_stack_1->SetBinError(9,246.7983);
   bmjeteta_t#bar{t}_stack_1->SetBinError(10,249.686);
   bmjeteta_t#bar{t}_stack_1->SetBinError(11,255.8626);
   bmjeteta_t#bar{t}_stack_1->SetBinError(12,251.409);
   bmjeteta_t#bar{t}_stack_1->SetBinError(13,256.0701);
   bmjeteta_t#bar{t}_stack_1->SetBinError(14,261.1412);
   bmjeteta_t#bar{t}_stack_1->SetBinError(15,254.0663);
   bmjeteta_t#bar{t}_stack_1->SetBinError(16,245.7197);
   bmjeteta_t#bar{t}_stack_1->SetBinError(17,235.742);
   bmjeteta_t#bar{t}_stack_1->SetBinError(18,220.4785);
   bmjeteta_t#bar{t}_stack_1->SetBinError(19,194.4789);
   bmjeteta_t#bar{t}_stack_1->SetBinError(20,181.5029);
   bmjeteta_t#bar{t}_stack_1->SetBinError(21,156.4664);
   bmjeteta_t#bar{t}_stack_1->SetBinError(22,132.275);
   bmjeteta_t#bar{t}_stack_1->SetBinError(23,117.3091);
   bmjeteta_t#bar{t}_stack_1->SetBinError(24,96.18803);
   bmjeteta_t#bar{t}_stack_1->SetEntries(36714);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__14->SetEntries(43105);
