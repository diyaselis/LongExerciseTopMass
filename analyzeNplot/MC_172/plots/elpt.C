...
// ------------>Primitives in pad: p1
   ...
   frame__25->SetMaximum(31819.94);
   frame__25->SetEntries(365945);
   ...
   mc_stack_13->SetMaximum(25700.72);
   ...
   elpt_t#bar{t}_stack_1->SetBinContent(3,21257.14);
   elpt_t#bar{t}_stack_1->SetBinContent(4,23455.5);
   elpt_t#bar{t}_stack_1->SetBinContent(5,21115.25);
   elpt_t#bar{t}_stack_1->SetBinContent(6,17296.59);
   elpt_t#bar{t}_stack_1->SetBinContent(7,13474.73);
   elpt_t#bar{t}_stack_1->SetBinContent(8,10224.24);
   elpt_t#bar{t}_stack_1->SetBinContent(9,7635.467);
   elpt_t#bar{t}_stack_1->SetBinContent(10,5857.853);
   elpt_t#bar{t}_stack_1->SetBinContent(11,4339.298);
   elpt_t#bar{t}_stack_1->SetBinContent(12,3190.837);
   elpt_t#bar{t}_stack_1->SetBinContent(13,2401.909);
   elpt_t#bar{t}_stack_1->SetBinContent(14,1821.771);
   elpt_t#bar{t}_stack_1->SetBinContent(15,1331.964);
   elpt_t#bar{t}_stack_1->SetBinContent(16,1040.229);
   elpt_t#bar{t}_stack_1->SetBinContent(17,820.3259);
   elpt_t#bar{t}_stack_1->SetBinContent(18,593.3406);
   elpt_t#bar{t}_stack_1->SetBinContent(19,473.0567);
   elpt_t#bar{t}_stack_1->SetBinContent(20,373.878);
   elpt_t#bar{t}_stack_1->SetBinContent(21,259.5852);
   elpt_t#bar{t}_stack_1->SetBinContent(22,232.6877);
   elpt_t#bar{t}_stack_1->SetBinContent(23,162.2287);
   elpt_t#bar{t}_stack_1->SetBinContent(24,144.4005);
   elpt_t#bar{t}_stack_1->SetBinContent(25,105.8413);
   elpt_t#bar{t}_stack_1->SetBinContent(26,82.95359);
   elpt_t#bar{t}_stack_1->SetBinContent(27,74.13413);
   elpt_t#bar{t}_stack_1->SetBinContent(28,57.63228);
   elpt_t#bar{t}_stack_1->SetBinContent(29,46.92937);
   elpt_t#bar{t}_stack_1->SetBinContent(30,34.80344);
   elpt_t#bar{t}_stack_1->SetBinContent(31,33.36621);
   elpt_t#bar{t}_stack_1->SetBinContent(32,24.94536);
   elpt_t#bar{t}_stack_1->SetBinContent(33,22.86686);
   elpt_t#bar{t}_stack_1->SetBinContent(34,19.25263);
   elpt_t#bar{t}_stack_1->SetBinContent(35,17.05536);
   elpt_t#bar{t}_stack_1->SetBinContent(36,15.98677);
   elpt_t#bar{t}_stack_1->SetBinContent(37,12.93275);
   elpt_t#bar{t}_stack_1->SetBinContent(38,8.902909);
   elpt_t#bar{t}_stack_1->SetBinContent(39,5.008532);
   elpt_t#bar{t}_stack_1->SetBinContent(40,3.550388);
   elpt_t#bar{t}_stack_1->SetBinContent(41,32.82383);
   elpt_t#bar{t}_stack_1->SetBinError(3,92.47626);
   elpt_t#bar{t}_stack_1->SetBinError(4,97.59356);
   elpt_t#bar{t}_stack_1->SetBinError(5,92.95179);
   elpt_t#bar{t}_stack_1->SetBinError(6,84.3237);
   elpt_t#bar{t}_stack_1->SetBinError(7,74.41731);
   elpt_t#bar{t}_stack_1->SetBinError(8,64.81346);
   elpt_t#bar{t}_stack_1->SetBinError(9,56.02557);
   elpt_t#bar{t}_stack_1->SetBinError(10,49.78941);
   elpt_t#bar{t}_stack_1->SetBinError(11,42.94611);
   elpt_t#bar{t}_stack_1->SetBinError(12,36.80214);
   elpt_t#bar{t}_stack_1->SetBinError(13,31.89275);
   elpt_t#bar{t}_stack_1->SetBinError(14,27.82986);
   elpt_t#bar{t}_stack_1->SetBinError(15,23.78379);
   elpt_t#bar{t}_stack_1->SetBinError(16,21.00303);
   elpt_t#bar{t}_stack_1->SetBinError(17,18.66969);
   elpt_t#bar{t}_stack_1->SetBinError(18,15.87532);
   elpt_t#bar{t}_stack_1->SetBinError(19,14.21922);
   elpt_t#bar{t}_stack_1->SetBinError(20,12.60896);
   elpt_t#bar{t}_stack_1->SetBinError(21,10.48438);
   elpt_t#bar{t}_stack_1->SetBinError(22,9.960118);
   elpt_t#bar{t}_stack_1->SetBinError(23,8.299523);
   elpt_t#bar{t}_stack_1->SetBinError(24,7.819699);
   elpt_t#bar{t}_stack_1->SetBinError(25,6.668847);
   elpt_t#bar{t}_stack_1->SetBinError(26,5.906875);
   elpt_t#bar{t}_stack_1->SetBinError(27,5.613548);
   elpt_t#bar{t}_stack_1->SetBinError(28,4.955465);
   elpt_t#bar{t}_stack_1->SetBinError(29,4.494946);
   elpt_t#bar{t}_stack_1->SetBinError(30,3.861459);
   elpt_t#bar{t}_stack_1->SetBinError(31,3.739607);
   elpt_t#bar{t}_stack_1->SetBinError(32,3.245849);
   elpt_t#bar{t}_stack_1->SetBinError(33,3.124474);
   elpt_t#bar{t}_stack_1->SetBinError(34,2.895844);
   elpt_t#bar{t}_stack_1->SetBinError(35,2.727634);
   elpt_t#bar{t}_stack_1->SetBinError(36,2.628187);
   elpt_t#bar{t}_stack_1->SetBinError(37,2.333166);
   elpt_t#bar{t}_stack_1->SetBinError(38,1.909615);
   elpt_t#bar{t}_stack_1->SetBinError(39,1.457253);
   elpt_t#bar{t}_stack_1->SetBinError(40,1.223506);
   elpt_t#bar{t}_stack_1->SetBinError(41,3.739333);
   elpt_t#bar{t}_stack_1->SetEntries(360257);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__26->SetEntries(365945);
   ...
   Graph_Graph_from_ratio3026->SetMaximum(2.423742);
