...
//=========  (Wed Jan 15 21:34:07 2020) by ROOT version 6.14/09
...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.7228916,-26010.87,5.301205,190747.2);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__21->SetMaximum(188579.6);
   frame__21->SetEntries(365945);
   ...
   mc_stack_11->SetMaximum(152314.3);
   ...
   nleptons_t#bar{t}_stack_1->SetBinContent(3,138101.4);
   nleptons_t#bar{t}_stack_1->SetBinError(3,238.1928);
   nleptons_t#bar{t}_stack_1->SetEntries(360257);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__22->SetEntries(365945);
   ...
   Graph_Graph_from_ratio3022->SetMaximum(0.9975832);
